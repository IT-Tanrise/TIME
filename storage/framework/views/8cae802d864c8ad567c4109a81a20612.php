                                ...
                                <tr class="border-b">
                                    <td class="px-4 py-2">
                                        <div class="flex items-center">
                                            <img class="h-8 w-8 rounded-full" src="<?php echo e($user->profile_photo_url); ?>" alt="<?php echo e($user->name); ?>">
                                    ...
                                    <td class="px-4 py-2">
                                        <div class="flex space-x-2">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('users.edit')): ?>
                                                <a href="<?php echo e(route('users.edit', $user)); ?>" class="text-green-600 hover:text-green-900">Edit</a>
                                            <?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\xampp\tanrise-portal2\resources\views/users/index.blade.php ENDPATH**/ ?>