        ...
        <div class="p-4 bg-white border-b border-gray-200">
            ...
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-lg font-semibold text-gray-900">
                    <?php echo e($isEdit ? 'Edit Ownership Details' : 'Create New Ownership'); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" 
                                    ...
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-xs <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($showPartnerNameDropdown): ?>
                                    <div class="absolute z-50 mt-1 w-full bg-white shadow-lg rounded-md py-1 text-xs ring-1 ring-black ring-opacity-5 focus:outline-none"
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if(empty($partnerNameSearch ?? '') && $partnerNames->count() > 0): ?>
                                        ...
                                        <div class="max-h-48 overflow-y-auto">
                                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $partnerNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <button type="button"
                                                        wire:click.stop="selectPartnerName('<?php echo e(addslashes($partner->name)); ?>')"
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($partnerNames->count() >= 20): ?>
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    <input wire:model="percentage" 
                                           ...
                                           min="0"
                                           max="100"
                                           class="block w-full px-2 py-1.5 pr-8 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-xs <?php $__errorArgs = ['percentage'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['percentage'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div>
                                ...
                                <input wire:model.live="lembar_saham_display" 
                                    ...
                                    class="mt-1 block w-full px-2 py-1.5 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-xs <?php $__errorArgs = ['lembar_saham'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    x-on:input="
                                        ...
                                        if (value) {
                                            ...
                                            window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('lembar_saham', parseInt(value));
                                        } else {
                                            $event.target.value = '';
                                            window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('lembar_saham', '');
                                        }
                                    ">
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['lembar_saham'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="flex justify-end space-x-2">
                        ...
                        <button type="submit" 
                            ...
                            <?php echo e($isEdit ? 'Update Ownership' : 'Create Ownership'); ?>
...
<?php /**PATH C:\xampp\tanrise-portal2\resources\views/livewire/partners/form.blade.php ENDPATH**/ ?>