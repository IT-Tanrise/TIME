                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <p class="text-sm text-gray-900 font-medium"><?php echo e($partner->name); ?></p>
                        </div>

                        <div>
                            <label class="block text-xs font-medium text-gray-700 mb-1">Business Unit</label>
                            <div class="flex items-center space-x-2">
                                <p class="text-sm text-gray-900"><?php echo e($partner->businessUnit->name ?? '-'); ?></p>
                                <!--[if BLOCK]><![endif]--><?php if($partner->businessUnit): ?>
                                    <span class="inline-flex px-2 py-0.5 text-xs rounded bg-blue-100 text-blue-800">
                                        <?php echo e($partner->businessUnit->code); ?>
                ...
                <div class="bg-blue-50 p-4 rounded-lg">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <p class="text-lg font-semibold text-indigo-600"><?php echo e($partner->formatted_percentage); ?></p>
                        </div>

                        <div>
                            <label class="block text-xs font-medium text-gray-700 mb-1">Lembar Saham</label>
                            <p class="text-sm text-gray-900 font-medium"><?php echo e($partner->formatted_lembar_saham); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-green-50 p-4 rounded-lg lg:col-span-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <p class="text-xs text-gray-600"><?php echo e($partner->created_at->format('d M Y H:i:s')); ?></p>
                        </div>

                        <div>
                            <label class="block text-xs font-medium text-gray-700 mb-1">Last Updated</label>
                            <p class="text-xs text-gray-600"><?php echo e($partner->updated_at->format('d M Y H:i:s')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6 pt-4 border-t border-gray-200">
                <div class="flex justify-between items-center">
                    <div class="text-xs text-gray-500">
                        Record ID: <?php echo e($partner->id); ?>
                    ...
                    <div class="flex space-x-2">
                        <!--[if BLOCK]><![endif]--><?php if($businessUnit): ?>
                            <button wire:click="backToBusinessUnit" 
                                ...
                                Back to <?php echo e($businessUnit->name); ?>
...
</div><?php /**PATH C:\xampp\tanrise-portal2\resources\views/livewire/partners/show.blade.php ENDPATH**/ ?>